-- Query: https://dune.com/queries/8797133
-- Matview: dune.paltalabs.result_scf_soroswap_users_history   cron: None
-- Última ejecución: 01M32GD6Z58WEVKW17X0479EKJ
-- Costo: 1.77 cr; filas: 9974; engine medium
-- Bootstrap of the history layer from existing matviews. Replaced by the incremental SQL after the first run.
WITH r AS (
  SELECT protocol, activity_date, user_address, role, last_activity_at FROM dune.paltalabs.result_scf_soroswap_users_live
