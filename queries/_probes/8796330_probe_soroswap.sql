-- Query: https://dune.com/queries/8796330
-- Matview: None   cron: None
-- Última ejecución: 01M32BYZ2JE9BB735BNR1WZMVA
-- Costo: 1.887 cr; filas: 4; engine medium
WITH source AS (WITH pairs AS (
...
ev AS (
  ...
  WHERE he.closed_at_date >= CURRENT_DATE - INTERVAL '7' DAY AND he.closed_at_date < CURRENT_DATE
